      ...
      <div class="row w-100">
        <div class="col-2 col-md-4 navbar-col order-md-1">
          <a href="index.html" class="brand-logo">
            <img src="{{ URL::asset('admin/assets/images/logo_6.svg') }}" alt="logo">
          </a>
          <a href="index.html" class="brand-logo-mini">
            <img src="{{ URL::asset('admin/assets/images/logo-mini_6.svg') }}" alt="logo">
          </a>
        </div>
          ...
          <ul class="nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle" src="{{ URL::asset('admin/assets/images/faces/face1.jpg') }}" alt="Profile image">
                <span class="profile-text">Allen Moreno</span>
              </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="{{ URL::asset('admin/assets/images/faces/face1.jpg') }}" alt="Profile image">
